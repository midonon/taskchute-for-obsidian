...
export const en = {
  ...
  sectionProfiles: {
    ...
    open: "Open section settings",
    label: "Section: {name}",
    current: "Current settings",
    weekday: "Weekday",
    holiday: "Holiday",
    manage: "Manage section profiles",
    manageDescription:
    ...
    defaultSettings: "Default section settings",
    defaultDescription:
    ...
    weekdays: {
      ...
      none: "Do not apply automatically",
      save: "Save weekday settings",
      cancel: "Cancel",
      saved: "Weekday settings saved",
      loadFailed: "Failed to load weekday settings",
      saveFailed: "Failed to save weekday settings",
      applyFailed:
        "Could not apply weekday settings. Existing sections are unchanged.",
    },
    targetDate: "Display date: {date}",
    dateDescription:
      "Saving a setting does not change this date. Applying it changes only this date. Other dates are unchanged.",
    profileLabel: "Saved setting",
    nameLabel: "Name",
    namePlaceholder: "e.g. Weekday",
    boundariesLabel: "Section start times and names",
    ...
    addRow: "Add row",
    rowStartTime: "Row {row}: start time",
    rowName: "Row {row}: name (optional)",
    removeRow: "Remove row {row}",
    newProfile: "New setting",
    cancel: "Cancel",
    save: "Save setting",
    apply: "Apply to display date",
    errors: {
      noProfile: "Select a section setting first",
      nameRequired: "Enter a name for the section setting",
      minimum: "At least 2 section times are required",
      emptyTime: "Enter a start time for every row",
      invalidFormat: "Enter each time in h:mm or hh:mm format",
      duplicate: "Duplicate section times are not allowed",
      firstMustBeZero: "The first section time must be 0:00",
      notAscending: "Section times must be in ascending order",
    },
    notices: {
      loadFailed: "Failed to load section settings",
      saved: "Section setting saved",
      saveFailed: "Failed to save the section setting",
      applied: "Applied section setting to {date}",
      applyFailed: "Failed to apply the section setting",
    },
  },
  notices: {
